...
use millau_runtime::{
	AccountId, AuraConfig, BalancesConfig, BridgeTemplateGrandpaConfig, BridgeWestendGrandpaConfig, GenesisConfig,
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		pallet_bridge_grandpa_Instance2: BridgeTemplateGrandpaConfig {

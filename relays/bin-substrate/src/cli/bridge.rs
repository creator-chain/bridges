...
impl FullBridge {
	...
	pub fn bridge_instance_index(&self) -> u8 {
		match self {
			...
			Self::MillauToTemplate => MILLAU_TO_TEMPLATE_INDEX,
		}
	}
}
...
pub const MILLAU_TO_TEMPLATE_INDEX: u8 = 0;
	...
	($bridge: expr, $generic: tt) => {
		match $bridge {
			...
			FullBridge::TemplateToMillau => {
				...
				// Relay-messages
				#[allow(unused_imports)]
				use crate::chains::template_messages_to_millau::run as relay_messages;
				...
				// Send-message
				#[allow(unused_imports)]
				use template_runtime::millau_account_ownership_digest as account_ownership_digest;

				$generic
			}
			FullBridge::MillauToTemplate => {
				type Source = relay_millau_client::Millau;
				#[allow(dead_code)]
				...
				// Derive-account
				#[allow(unused_imports)]
				use bp_millau::derive_account_from_template_id as derive_account;

				// Relay-messages
				#[allow(unused_imports)]
				use crate::chains::millau_messages_to_template::run as relay_messages;

				// Send-message / Estimate-fee
				#[allow(unused_imports)]
				use bp_template::TO_TEMPLATE_ESTIMATE_MESSAGE_FEE_METHOD as ESTIMATE_MESSAGE_FEE_METHOD;

				// Send-message
				#[allow(unused_imports)]
				use millau_runtime::template_account_ownership_digest as account_ownership_digest;
